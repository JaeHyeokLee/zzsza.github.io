...
- 운영체제
	...
	- 메모리에 Resident(상주)
	- <img src="https://www.dropbox.com/s/667llmih1t3472y/Screenshot%202018-07-27%2000.41.15.png?raw=1" height="200" weight="300">
...
- 프로그램 vs 프로세스 (program vs process)	- process, task, job …	- 프로세스 : 실행중인 프로그램(program in execution): text + data + stack, pc, sp, registers, …
	...
	- <img src="https://www.dropbox.com/s/7gdvnhnk2t0cl6n/Screenshot%202018-07-27%2013.43.57.png?raw=1">  	- new, ready, running, waiting, terminated 
		- new : 메인 메모리에 올라온 상태
